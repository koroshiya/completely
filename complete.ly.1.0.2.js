        ...
        var p = {
            ...
            refresh : function(token, array) {
                ...
                for (var i=0;i<array.length;i++) {
                    if (config.ignoreCase && array[i].toLowerCase().indexOf(token.toLowerCase())!==0){
                        continue;
                    }else if (array[i].indexOf(token)!==0) {
                        continue;
                    }
    ...
    var rs = { 
        ...
        repaint : function() {
            ...
            for (var i=0;i<optionsLength;i++) {
                var opt = options[i];
                if ((config.ignoreCase && opt.toLowerCase().indexOf(token)===0) || (opt.indexOf(token)===0)){
